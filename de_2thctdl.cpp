...
void nhap(DAYSO &ds);
void xuat(DAYSO ds);
void xoa1PT(DAYSO& ds, int pos);
void thayThe(DAYSO& ds, int pos, int x);
...
void tongChan(NODEPTR list);
void xuat_PT_Am(NODEPTR list);
void xuat_PT_X(NODEPTR list, TYPEINFO x);
...
void tongChan(NODEPTR list)
{
	...
	cout << "\nTong cac ptu chan trong DS : " << tong;
}
void xuat_PT_X(NODEPTR list, TYPEINFO x)
{
	NODEPTR p = list;
